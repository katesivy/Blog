  ...
  <div  className="row no-gutters">
    ...
    <div  className="col-md-8">
      <div  className="card-body">
        ...
        <div className="card-body">
          <a href="https://www.linkedin.com/in/kate-sivy-7104791a2/" className="card-link">Linkedin</a>
          <a href="https://github.com/katesivy" className="card-link">GitHub</a>
          <a href="https://docs.google.com/document/d/1DdmmnfULxxHjBfoEPDagHIf0a2QfUDXjPGpRj8fno1A/edit#heading=h.n64fgzu3lwuyy" className="card-link">Resume</a>
        </div>
      {/* </div> */}
      <div className="card">
